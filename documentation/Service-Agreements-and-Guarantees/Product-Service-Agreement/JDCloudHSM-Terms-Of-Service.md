**本服务条款是京东云网站所有者（本协议中称为“京东云”网址：**[www.jdcloud.com](http://www.jcloud.com/index)**）与您就数据加密服务的相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本服务条款，包括但不限于未点击确认本服务条款而事实上使用了京东云数据加密服务，即表示您与京东云已达成协议并同意接受本服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。**
...
1.1 本条款中“服务”指：京东云向您提供[www.jdcloud.com](https://www.jcloud.com/)网站上所展示的数据加密服务以及相关的技术及网络支持服务。
...
2.2 数据加密服务实例目前支持预付费方式，京东云会在您付费之后开始为您提供服务。

2.3 **数据加密服务实例到期后双方愿意继续合作的，您至少应在服务期满前30天前支付续费款项，以使服务得以继续进行。如续费时京东云对产品体系、名称或价格进行调整的，双方同意按照届时有效的新的产品体系、名称或价格履行。** 
...
3.1.1 **您同意遵守本服务条款以及服务展示页面的相关管理规范及流程。您了解上述协议及规范等的内容可能会不时变更。如本服务条款的任何内容发生变动，京东云应通过提前在**[**www.jdcloud.com**](https://www.jcloud.com/)**的适当版面公告向您提示修改内容。如您不同意京东云对本服务条款相关条款所做的修改，您有权停止使用京东云的服务，此等情况下，京东云应与您进行服务费结算（如有），并且您应将业务数据迁出。如您继续使用京东云服务，则视为您接受京东云对本服务条款相关条款所做的修改。**
...
**3.1.3.5** **您利用数据加密服务进行防护的业务须为正常的商业、科研等符合国家法律规定的业务，不得用于从事任何非法业务，包括但不限于:** 
...
**3.1.8 您应仔细阅读京东云就数据加密服务在京东云网站上的服务说明，自行判断数据加密服务与您选择适用的操作系统、浏览器、云服务器等产品或服务的适配性。** 

**3.1.9 您应依照相关操作指引进行操作。由您手动设置的部分（如您对数据加密服务审核信息相关内容的设置）及其产生的结果由您自行负责，请您自行把握风险并谨慎操作。** 
...
7.1 数据加密服务免费开通，数据加密服务自您购买之日起30日内如未提交审核申请则可以退款，数据加密服务有效期自您的审核材料通过审核之日起开始计算，至法律规定或本服务条款约定的终止情形出现之时终止。 
...
7.2.3如因用户数据加密服务过期或被吊销影响用户网站和服务的不可用，京东云无须承担任何义务和责任。 

7.2.4 京东云可提前在[www.jdcloud.com](https://www.jcloud.com/)上通告或给您发网站内通知或书面通知的方式终止本服务条款。届时京东云应将您已支付但未消费的款项退还至您的京东云账户。

#### 8. 违约责任

8.1 本服务条款任何一方违约均须依法承担违约责任。

8.2如果因京东云原因造成您申请的数据加密服务不能正常使用，您可终止接受服务，但非京东云控制之内的原因引起的除外。 
...
11.1 京东云在[www.jdcloud.com](https://www.jcloud.com/)相关页面上的服务说明、价格说明和您确认同意的订购页面是本服务条款不可分割的一部分。如果[www.jdcloud.com](https://www.jcloud.com/)相关页面上的服务说明、价格说明和您确认同意的订购页面与本服务条款有不一致之处，以本服务条款为准。

11.2 京东云有权以提前在[www.jdcloud.com](https://www.jcloud.com/)上公布、或给您发网站内通知或书面通知的方式将本服务条款的权利义务全部或者部分转移给京东云的关联公司。
