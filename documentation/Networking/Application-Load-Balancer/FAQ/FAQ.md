...
举例1：应用负载均衡配置了转发规则1(域名:www.abc.com ，URL路径：/path1/abc/或/path/abc/\*，后端服务：backend)，未配置转发规则2(域名：www.abc.com，URL 路径： /path/abc，后端服务：backend)。用户访问 http://www.abc.com/path1/abc， 应用负载均衡收到访问请求时，会执行301重定向返回http://www.abc.com/path1/abc/ ，访问流量将匹配转发规则1分发给backend处理。
如用户不想应用负载均衡执行301重定向，可配置转发规则2（域名：www.abc.com ，URL路径：/path1/abc，后端服务：backend），通过该转发规则明确指定访问请求http://www.abc.com/path1/abc 的转发行为。
