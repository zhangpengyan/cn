...
- **丰富的边缘节点：**
覆盖国内的边缘节点，目前华东-台州（电信）已开放，其他节点还在筹备中，后面陆续开放。
- **多种实例规格：**
提供计算型、存储型两类实例。目前已上架多种不同规格详细规格，满足用户不同业务场景，详情参见[产品规格](../Introduction/Specifications.md)。更多实例规格正在筹备中。
- **灵活计费方式：**
...
- **隔离的网络架构：**
用户之间内网互相隔离，与您在边缘节点的传统网络类似，此私有网络空间由用户完全掌控，支持自定义内网CIDR网段划分。
- **快速批量部署：**
