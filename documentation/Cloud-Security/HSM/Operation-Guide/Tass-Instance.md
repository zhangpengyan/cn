...
![原始初始化10](/image/HSM/Tass/原始初始化10.png)

13. 数据加密服务的初始化就完成了。

![原始初始化11](/image/HSM/Tass/原始初始化11.png)
