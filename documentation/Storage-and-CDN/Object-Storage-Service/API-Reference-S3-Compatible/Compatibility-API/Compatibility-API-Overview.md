...
|POST Object restore|恢复归档存储对象得到临时副本|未支持Select<br>兼容[POST Object restore](./Operations-On-Objects/POST Object restore.md)|[POST Object restore](https://docs.aws.amazon.com/zh_cn/AmazonS3/latest/API/RESTObjectPOSTrestore.html)|
